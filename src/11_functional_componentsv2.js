    ...
    return (<div className="col-lg-4 col-sm-6 mb-4">
        ...
        <div className="portfolio-item">
            <a className="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                ...
                <img className="img-fluid" src={"assets/img/portfolio/ " + props.photo } alt="..." />
            </a>
            <div className="portfolio-caption">
                <div className="portfolio-caption-heading">{props.title}</div>
                <div className="portfolio-caption-subheading text-muted">{props.category}</div>
            </div>
        </div>
    </div>)
}
function Portfolio() {
    return (<section className="page-section bg-light" id="portfolio">
        <div className="container">
            ...
            <div className="row">
                <PortfolioItem title='Code' category='Development' photo='1.jpg' />
                <PortfolioItem title='Nexus' category='Web' photo='2.jpg' />
                <PortfolioItem title='Pixel' category='Design' photo='3.jpg' />
                <PortfolioItem title='Launch' category='Startup' photo='4.jpg' />
                <PortfolioItem title='Fusion' category='Fullstack' photo='5.jpg' />
                <PortfolioItem title='Reactify' category='Frontend' photo='6.jpg' />
...
function TeamIteam(props){
    return( <div className="team-member">
                        <img className="mx-auto rounded-circle" src={"assets/img/team/"+ props.photo} alt="..." />
                        <h4>{props.name}</h4>
                        <p className="text-muted">{props.role}</p>
                        <a className="btn btn-dark btn-social mx-2" href="#!" aria-label= {props.name + "Twitter Profile"}><i className="fab fa-twitter" /></a>
                        <a className="btn btn-dark btn-social mx-2" href="#!" aria-label={props.name + "Facebook Profile"}><i className="fab fa-facebook-f" /></a>
                        <a className="btn btn-dark btn-social mx-2" href="#!" aria-label={props.name + "LinkedIn Profile"}><i className="fab fa-linkedin-in" /></a>
                    </div>);
}
function Team() {
        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-lg-4">
                     <TeamIteam name='Aarav Mehta' role='Lead Designer' photo='1.jpg' />
                     <TeamIteam name='Priya Shah' role='Lead Marketer' photo='2.jpg' />
                     <TeamIteam name='Rohan Patel' role='Lead Developer' photo='3.jpg' />
                </div>            
            </div>
            <div className="row">
